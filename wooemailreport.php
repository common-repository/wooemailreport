...
class Wooreport_Plugin {
	...
	public static function wooreport_page () {
		...
		if ( isset( $_POST['test'] ) ) { // send a test email	
			...
			$to = $_POST['emails'];
			$subject = 'WooEmailReport - Test email';
			$message = $output;
		...
		$button_text = __( 'Save', 'wooemailreport' );
		...
		echo '				</select>
					...
					<tr valign="top">
		        		...
		        		<td> 
	        				<select name="report">
								<option value="totals">' . __( 'Totals', 'wooemailreport' ) . '</option>
								<option value="daily">' . __( 'Daily', 'wooemailreport' ) . '</option>
	        				</select>
	        			</td>
	        		</tr>
	        		<tr valign="top">
	        			<th scope="row">' . __( 'Time (UTC):', 'wooemailreport' ) . '</th>
		        		<td> 
	        				<select name="hour">
    ...
    <tr>
        <tr>
            <th id="columnname" class="manage-column column-columnname" scope="col">' . __( 'Frecuency', 'wooemailreport' ) . '</th> 
            <th id="columnname" class="manage-column column-columnname" scope="col">' . __( 'Report type', 'wooemailreport' ) . '</th>
            <th id="columnname" class="manage-column column-columnname " scope="col">' . __( 'Emails', 'wooemailreport' ) . '</th> 
        </tr>
    </tr>
    </thead>
    ...
    <tbody>
		...
		echo '</td><td>';
		echo '<span>' . __( 'Email', 'wooemailreport' ) . ':</span><input type="text" name="emails" value=""/>';		
		echo '</td></tr></table>';

		echo '<p class="description"">' . __( 'If you do not receive an email in your inbox, please check your spam folder.', 'wooemailreport' ) . '</p>';
		submit_button(__( 'Send Test email', 'wooemailreport' ), 'primary', 'test');
